...
public sealed class Ballet : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "PIROUETTE_MOVE";

    public override int MinInitialHp => 22;
    public override int MaxInitialHp => 28;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/ballet.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Ballet",
        MoveTitles: new[] { (MoveIdConst, "Pirouette") });

    private int MoveDamage => 6;
