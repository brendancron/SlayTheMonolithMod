...
// Elite-variant of Renoir for TheAxons. The "Elite" suffix is intentional --
// later acts will introduce non-elite Renoir variants (boss / event combat /
// etc.) that share the surname but differ mechanically. This one is the
// InfestedPrism mirror: 200 HP, VitalSpark 1 on entry, 4-state cycle Jab ->
// Radiate -> Whirlwind -> Pulsate -> loop, same values as Monoco.
public sealed class RenoirElite : CustomMonsterModel, ILocalizationProvider
{
    ...
    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/renoir_elite.tscn";
