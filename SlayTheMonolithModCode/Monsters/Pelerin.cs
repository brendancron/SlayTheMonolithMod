...
public sealed class Pelerin : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "PILGRIM_STRIKE";

    public override int MinInitialHp => 26;
    public override int MaxInitialHp => 32;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/pelerin.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Pelerin",
        MoveTitles: new[] { (MoveIdConst, "Pilgrim Strike") });
