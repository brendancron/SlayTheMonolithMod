...
public sealed class Aberration : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "WARP_MOVE";

    public override int MinInitialHp => 26;
    public override int MaxInitialHp => 32;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/aberration.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Aberration",
        MoveTitles: new[] { (MoveIdConst, "Warp") });
