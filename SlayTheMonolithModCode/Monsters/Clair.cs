...
public sealed class Clair : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "GLEAM_MOVE";

    public override int MinInitialHp => 26;
    public override int MaxInitialHp => 32;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/clair.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Clair",
        MoveTitles: new[] { (MoveIdConst, "Gleam") });
