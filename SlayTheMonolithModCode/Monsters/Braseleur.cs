...
public sealed class Braseleur : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "BRAZIER_MOVE";

    public override int MinInitialHp => 28;
    public override int MaxInitialHp => 34;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/braseleur.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Braseleur",
        MoveTitles: new[] { (MoveIdConst, "Brazier") });
