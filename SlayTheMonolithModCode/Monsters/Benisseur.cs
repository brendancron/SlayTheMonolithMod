...
public sealed class Benisseur : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "BLESS_MOVE";

    public override int MinInitialHp => 24;
    public override int MaxInitialHp => 30;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/benisseur.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Benisseur",
        MoveTitles: new[] { (MoveIdConst, "Bless") });
