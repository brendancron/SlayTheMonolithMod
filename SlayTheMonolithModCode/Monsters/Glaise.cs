...
// Functionally identical to vanilla VineShambler (same as Bruler).
//   Swipe (6x2) -> Grasping (8 + apply Tangled) -> Chomp (16) -> Swipe ...
//   Initial state = Swipe. 61 HP.
public sealed class Glaise : CustomMonsterModel, ILocalizationProvider
{
    ...
    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/glaise.tscn";
