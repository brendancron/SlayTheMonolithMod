...
public sealed class Obscur : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "OBSCURE_MOVE";

    public override int MinInitialHp => 28;
    public override int MaxInitialHp => 34;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/obscur.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Obscur",
        MoveTitles: new[] { (MoveIdConst, "Obscure") });
