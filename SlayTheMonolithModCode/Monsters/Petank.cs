...
public sealed class Petank : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "TOSS_MOVE";

    public override int MinInitialHp => 30;
    public override int MaxInitialHp => 36;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/petank.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Petank",
        MoveTitles: new[] { (MoveIdConst, "Toss") });
