...
public sealed class Veilleur : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "VIGIL_MOVE";

    public override int MinInitialHp => 28;
    public override int MaxInitialHp => 34;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/veilleur.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Veilleur",
        MoveTitles: new[] { (MoveIdConst, "Vigil") });
