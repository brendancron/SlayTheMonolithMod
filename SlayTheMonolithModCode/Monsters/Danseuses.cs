...
public sealed class Danseuses : CustomMonsterModel, ILocalizationProvider
{
    private const string MoveIdConst = "WALTZ_MOVE";

    public override int MinInitialHp => 24;
    public override int MaxInitialHp => 30;

    public override string CustomVisualPath =>
        "res://SlayTheMonolithMod/scenes/creature_visuals/danseuses.tscn";
    ...
    public List<(string, string)>? Localization => new MonsterLoc(
        Name: "Danseuses",
        MoveTitles: new[] { (MoveIdConst, "Waltz") });
